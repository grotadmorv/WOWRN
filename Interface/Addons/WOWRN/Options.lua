...
local function CreateOptionsPanel()
    ...
    desc:SetText("Affiche les informations Best-in-Slot et Tier List sur les tooltips des objets.")
    ...
    enableTooltips.Text:SetText("Activer les infos BiS dans les tooltips")
    ...
    showMinimap.Text:SetText("Afficher le bouton sur la minimap")
    ...
    openCatalog:SetText("Ouvrir le Catalogue")
    ...
    commands:SetText("Commandes:")
    yOffset = yOffset - 18
    local cmdList = panel:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
    cmdList:SetPoint("TOPLEFT", 16, yOffset)
    cmdList:SetText("|cFF00FF00/wowrn|r - Ouvrir le catalogue\n|cFF00FF00/wowrn minimap|r - Afficher/cacher le bouton minimap\n|cFF00FF00/wowrn help|r - Aide")
